...
{ 
 ...
 gluScaleImage(format, image->width, image->height, GL_UNSIGNED_BYTE,
               image->bits, width, height, GL_UNSIGNED_BYTE, image->texels);
 ...
 glBufferData(GL_PIXEL_UNPACK_BUFFER_ARB,
              width * height * sizeof(uchar4), image->texels,
              GL_STREAM_COPY);
