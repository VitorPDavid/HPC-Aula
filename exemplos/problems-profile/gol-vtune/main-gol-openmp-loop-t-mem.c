...
//    mLattice.buff1 = (unsigned char*) malloc (mLattice.width *   mLattice.height *  sizeof(unsigned char));
      mLattice.buff0 =  (unsigned char*) aligned_alloc(ALIGN, mLattice.width *   mLattice.height *  sizeof(unsigned char));
      mLattice.buff1 =  (unsigned char*) aligned_alloc(ALIGN, mLattice.width *   mLattice.height *  sizeof(unsigned char));
...
{
  char fileName[128];
  sprintf(fileName, "%s-log.bin", __FILE__);
